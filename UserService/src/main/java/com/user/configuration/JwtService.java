...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails){
        ...
        redisTokenService.saveToken(token,userDetails.getUsername(),tokenTime / 1000);
    ...
    public Boolean validateToken(String token,UserDetails userDetails){
        ...
        return redisTokenService.validateToken(token) && username.equals(userDetails.getUsername());
    }
